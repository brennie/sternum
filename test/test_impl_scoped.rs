...
#[test]
fn impl_display() {
    assert_eq!(Enum::Foo.to_string(), "Enum::Foo");
    assert_eq!(Enum::Bar.to_string(), "Enum::Bar");
    assert_eq!(Enum::Baz.to_string(), "Enum::Baz");
}

#[test]
fn impl_from_str() {
    assert_eq!(str::parse::<Enum>("Enum::Foo"), Ok(Enum::Foo));
